...
return [
    'routes' => [
        ...
        ['name' => 'loyalty#validateRedemptionCode',  'url' => '/api/loyalty/redemption/{code}/validate',                   'verb' => 'POST'],
        ['name' => 'loyalty#useRedemptionCode',       'url' => '/api/loyalty/redemption/{code}/use',                        'verb' => 'POST'],
        ['name' => 'loyalty#validateGiftCard',  'url' => '/api/loyalty/gift-card/validate',              'verb' => 'POST'],
