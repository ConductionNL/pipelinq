...
>
> Active development now happens at **https://codeberg.org/Conduction/pipelinq**.
> This GitHub mirror is read-only — issues, pull requests, and new commits should go to Codeberg.
> Update your remote with: `git remote set-url origin https://codeberg.org/Conduction/pipelinq`<p align="center">
