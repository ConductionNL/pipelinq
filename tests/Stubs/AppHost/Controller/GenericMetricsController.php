 ...
 *
 * Minimal declaration so pipelinq's thin MetricsController subclass type-checks
...
if (class_exists(GenericMetricsController::class) === false) {
    /**
     * Stub for the engine's generic metrics controller.
     */
    class GenericMetricsController extends Controller
    {
         ...
         * @param MetricsEngine  $engine         Metrics rendering engine.
         */
        ...
        /**
         * Render the declarative Prometheus metrics.
         *
