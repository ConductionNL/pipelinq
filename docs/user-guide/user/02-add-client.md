...
The create button is labelled **Add Item**, the standard *@conduction/nextcloud-vue* list action used across every Pipelinq list view (Clients, Contacts, Leads, Requests, …).

![Add client button](/screenshots/user-guide/user/02-add-client-button.png)
...
![Type picker](/screenshots/user-guide/user/02-type-picker.png)
...
![Form filled](/screenshots/user-guide/user/02-form-filled.png)
...
![Saved client](/screenshots/user-guide/user/02-saved.png)
