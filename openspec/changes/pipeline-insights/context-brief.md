# Context Brief: Pipeline Insights

**App:** Pipelinq — CRM and customer interaction
**Spec:** pipeline-insights
**Platform:** Nextcloud + OpenRegister

## Features (10 total, sorted by market demand)

### CRM with sales pipeline management and opportunity tracking
**demand: 1664** (550 tender mentions) | Category: analytics

### Navi AI Analytics Agent: interactive procurement data visualization and reporting
**demand: 432** (139 tender mentions) | Category: ai

### Unified analytics layer with single data model providing real-time cross-module reporting
**demand: 240** (79 tender mentions) | Category: analytics

### Advanced spend analytics with custom reporting and data visualization
**demand: 198** (54 tender mentions) | Category: analytics

### Contract Portfolio Analytics and Reporting
**demand: 188** (48 tender mentions) | Category: other

### Data-Driven Decision Analytics and Funder Reporting
**demand: 145** (10 tender mentions) | Category: other

### Pipeline Breakdowns by Sales Stage
**demand: 22** (1 tender mentions) | Category: other

### Reporting and Analytics
**demand: 2** | Category: Reporting
Advanced HR reporting and analytics for data-driven decision making

### Statistics & Analytics
**demand: 2** | Category: Analytics
Gather statistics about area conditions and report patterns.

### Reporting & Analytics
**demand: 2** | Category: Reporting
Comprehensive reports on HR and payroll data with export capabilities
