...
# POS Multi-tender Payment (cash + card + voucher)

## Placement & Information Architecture

**Placement type:** `WIDGET+DETAIL_TAB` (compound — implement all of the following):
...
**Lives at:** Kassa → Kassascherm tender-pad + Bon-detail → Betaling

**Rationale:** Multi-tender pad widget; breakdown tab.  
...
One transaction settles via N tender lines; change calculation; PIN/contact/cash/giftcard tender types.

## Priority & Demand

- **Priority:** P0-must
- **Demand evidence:** 11/13 competitors
- **Dependencies:** pos-transaction-core

## Cross-app integration

Each tender posts to its own GL account in shillinq (kas, bank, debiteuren).
