...
### Task 1: Fix KennisbankHome.vue — remove duplicate blocks and consolidate
...
### Task 2: Implement ArticleListItem component
...
### Task 3: Implement CategoryTree and CategoryTreeNode components
...
### Task 4: Implement ArticleFeedback and FeedbackSummary components
...
### Task 5: Wire ArticleDetail.vue to Pinia store
...
### Task 6: Wire ArticleEditor.vue to Pinia store
...
### Task 7: Wire CategoryManager.vue to Pinia store
...
### Task 8: Fix PublicKennisbankControllerTest — remove duplicate methods
...
### Task 9: Fix KennisbankReviewJobTest — remove duplicate methods
- Remove all duplicate method definitions (merge conflict artifacts)
- Keep one clean version of each test
- Ensure all tests pass
- **Acceptance**: `phpunit --filter KennisbankReviewJobTest` passes with 0 errors

### Task 10: Add KennisbankServiceTest
...
### Task 11: Add KennisbankControllerTest
...
### Task 12: Run quality checks and fix issues
