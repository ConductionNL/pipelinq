...
# POS Product Catalogue (variants, modifiers)
...
**Lives at:** Catalogus → Product-detail → POS

**Rationale:** POS-config (variants/modifiers/barcodes) on shared product.  
...
Reuse pipelinq product-catalog; surface variants, modifiers, price tiers, BTW class.
...
Catalogue items map 1:1 to shillinq product master (single source of truth).
