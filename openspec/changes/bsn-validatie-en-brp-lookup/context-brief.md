...
**Placement type:** `ACTION+DETAIL_TAB` (compound — implement all of the following):
...
**Lives at:** Contacten-detail → BSN/BRP

**Rationale:** Conditional op overheid-tenant; action on person record.  
