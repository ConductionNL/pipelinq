# Activity Stream Publishing — Delta

**Spec refs**: ADR-041 (cross-app commands via events; gate-27 no-phantom-cross-app-rpc), ADR-031 (x-openregister-notifications dialect), `lib/Service/ActivityService.php`
**Standards**: Nextcloud `OCP\Activity\IManager` first-party Activity API
