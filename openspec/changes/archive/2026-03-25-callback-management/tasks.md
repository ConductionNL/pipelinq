...
- [x] 1.1 Create CallbackService with attempt logging, claim validation, status transitions, and threshold checks
...
- [x] 1.2 Update task schema in pipelinq_register.json with callback-specific properties
...
- [x] 2.1 Create CallbackController with attempt, claim, complete, and reassign endpoints
...
- [x] 3.1 Create CallbackOverdueJob for overdue callback detection and notification
...
- [x] 4.1 Write unit tests for CallbackService
...
- [x] 4.2 Write unit tests for CallbackController
...
- [x] 4.3 Write unit tests for CallbackOverdueJob
...
- [x] 5.1 Add English and Dutch translations for callback-related strings
