...
**Status:** proposed
**Scope:** pipelinq
**Change:** pipelinq-setup-wizard-complete

Completes the pipelinq setup wizard by adding optional, non-gating steps and the backend that persists/reports them. Currency remains the single required step (REQ-SETUP-PIP-001 unchanged).
