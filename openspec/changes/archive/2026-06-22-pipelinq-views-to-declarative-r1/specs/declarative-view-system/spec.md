# Declarative View System — round 1 deltas

**Spec ref**: `declarative-view-system`

This delta is view-rendering placement only — no feature contract, data model,
or API change. Each converted page renders the same register/schema, the same
columns, and routes to the same detail/editor as before.
