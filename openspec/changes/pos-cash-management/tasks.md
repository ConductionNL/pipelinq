...
- [ ] 8.2 Integration test: Full shift lifecycle (DEFERRED: requires live OpenRegister environment)
...
- [ ] 8.3 API endpoint tests (DEFERRED: requires live OpenRegister environment)
