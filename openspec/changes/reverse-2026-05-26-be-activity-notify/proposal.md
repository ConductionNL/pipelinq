# Reverse-spec — Activity and notification dispatch

Retroactively specifies the observed behavior of 3 method(s) implementing activity publishing and notification delivery. The code already exists and is exercised in the running app — this change documents its true capabilities as REQs and annotates each method with an `@spec` reference. No code logic changes.

## Affected code units

- `lib/Service/ActivityService.php::publishDealLost`
- `lib/Service/NotificationService.php::notifyDealLost`
- `lib/Service/NotificationService.php::sendNotification`
