...
- [ ] 1.1 Add `contactmoment` schema to `lib/Settings/pipelinq_register.json`
...
- [ ] 1.2 Add `contactmoment` to register schemas list in `pipelinq_register.json`
  - **files**: `pipelinq/lib/Settings/pipelinq_register.json`
  - **acceptance_criteria**:
...
- [ ] 2.1 Create `src/components/CallTimer.vue` — MM:SS elapsed timer with start/stop/reset
...
- [ ] 3.1 Create `src/views/contactmomenten/ContactmomentList.vue`
...
- [ ] 3.2 Create `src/views/contactmomenten/ContactmomentForm.vue` — channel-adaptive registration form
...
- [ ] 3.3 Create `src/views/contactmomenten/ContactmomentDetail.vue`
...
- [ ] 4.1 Add contactmomenten routes to `src/router/index.js`
...
- [ ] 4.2 Add "Contactmomenten" nav item to `src/navigation/MainMenu.vue`
...
- [ ] 5.1 Run `npm run build` and verify no compilation errors
- [ ] 5.2 Manually verify channel switching clears channelMetadata and shows correct fields
- [ ] 5.3 Manually verify CallTimer emits correct ISO 8601 duration on Stop
