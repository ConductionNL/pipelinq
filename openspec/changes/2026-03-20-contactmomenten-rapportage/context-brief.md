...
**Placement type:** `WIDGET+SUB_PAGE` (compound — implement all of the following):
...
**Lives at:** Klantcontact → Werkplek + Mijn werk

**Rationale:** Rapportage as dashboard widget; full report sub-page under Klantcontact.  
