...
The following REQs were drafted via `/opsx-reverse-spec` from observed behavior of `ActivityTimelineService` private helpers. Code already existed; these REQs retroactively specify it.
