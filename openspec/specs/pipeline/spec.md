...
#### Scenario: Create a pipeline with title and entity types
...
#### Scenario: Create a mixed entity pipeline
...
#### Scenario: Edit pipeline title and description
...
#### Scenario: Delete a pipeline with no items
...
#### Scenario: Delete a pipeline with active items
...
#### Scenario: Request-only pipeline
...
#### Scenario: Default pipelines are idempotent
...
#### Scenario: Mark stage as closed and won
...
#### Scenario: Mark stage as closed but not won
...
#### Scenario: Delete a stage with no items
...
#### Scenario: Delete a stage with items
...
#### Scenario: Stage order must be unique within pipeline
...
#### Scenario: Stage title is required
...
#### Scenario: Stage probability range
...
#### Scenario: Toggle from kanban to list view
...
#### Scenario: Toggle from list to kanban view
...
#### Scenario: Collapsed closed stages
...
#### Scenario: Column header with item count and value
...
#### Scenario: Column header with zero items
...
#### Scenario: Assign lead to pipeline on creation
...
#### Scenario: Assign lead to specific pipeline and stage
...
#### Scenario: Move entity between pipelines
...
#### Scenario: Remove entity from pipeline
...
#### Scenario: Auto-populate probability on stage change
...
#### Scenario: Stage without probability does not override
...
#### Scenario: Manual probability override after stage change
...
#### Scenario: Conversion rate between stages
...
#### Scenario: Render pipeline funnel
...
#### Scenario: Revenue per stage column
...
#### Scenario: Revenue excludes closed stages
...
#### Scenario: Create pipeline without title
...
#### Scenario: Create pipeline without stages
...
#### Scenario: Drag to same stage (duplicate event prevention)
...
#### Scenario: Admin deletes last non-closed stage
...
#### Scenario: Concurrent stage reorder conflict
...
#### Scenario: Display pipeline list in admin settings
...
#### Scenario: Switch between pipelines
...
#### Scenario: Pipeline dropdown shows entity type labels
...
### Requirement: Multiple Pipelines per Organization [V1]
...
### Requirement: Pipeline Template Creation [Enterprise]
...
### Requirement: Stage Automation on Transition [Enterprise]
...
### Requirement: Pipeline Filtering and Search [MVP]
...
### Requirement: Pipeline Access Control [V1]
...
### Requirement: Pipeline Dashboard Widgets [V1]
...
### Requirement: Stage SLA and Deadline Tracking [Enterprise]
...
### Requirement: Pipeline Reporting [V1]
...
### Requirement: Win/Loss Tracking [Enterprise]
...
### Requirement: Pipeline Sidebar Details [MVP]
...
### Requirement: View Persistence and User Preferences [V1]
...
### Requirement: Weighted Pipeline Value and Sales Forecast [V1]
