...
export const useKennisbankStore = defineStore('kennisbank', {
	...
	getters: {
		/**
		 * @spec openspec/changes/reverse-2026-05-26-fe-store/tasks.md#task-21
		 */
		...
		/**
		 * @spec openspec/changes/reverse-2026-05-26-fe-store/tasks.md#task-27
		 */
		visibleArticles(state) {
			return state.showArchived ? state.articles : state.articles.filter(a => a.status !== 'gearchiveerd')
		},
		/**
		 * @spec openspec/changes/reverse-2026-05-26-fe-store/tasks.md#task-22
		 */
		recentlyViewed() {
			try { const s = localStorage.getItem(RECENT_ARTICLES_KEY); return s ? JSON.parse(s) : [] } catch { return [] }
		},
		/**
		 * @spec openspec/changes/reverse-2026-05-26-fe-store/tasks.md#task-11
		 */
		categoryTree(state) {
		...
		/**
		 * @spec openspec/changes/reverse-2026-05-26-fe-store/tasks.md#task-9
		 */
	...
	actions: {
		/**
		 * @spec openspec/changes/reverse-2026-05-26-fe-store/tasks.md#task-8
		 */
		...
		/**
		 * @spec openspec/changes/reverse-2026-05-26-fe-store/tasks.md#task-7
		 */
		...
		/**
		 * @spec openspec/changes/reverse-2026-05-26-fe-store/tasks.md#task-19
		 */
		...
		/**
		 * @spec openspec/changes/reverse-2026-05-26-fe-store/tasks.md#task-17
		 */
		...
		/**
		 * @spec openspec/changes/reverse-2026-05-26-fe-store/tasks.md#task-13
		 */
		...
		/**
		 * @spec openspec/changes/reverse-2026-05-26-fe-store/tasks.md#task-25
		 */
		...
		/**
		 * @spec openspec/changes/reverse-2026-05-26-fe-store/tasks.md#task-15
		 */
		...
		/**
		 * @spec openspec/changes/reverse-2026-05-26-fe-store/tasks.md#task-20
		 */
		...
		/**
		 * @spec openspec/changes/reverse-2026-05-26-fe-store/tasks.md#task-14
		 */
		...
		/**
		 * @spec openspec/changes/reverse-2026-05-26-fe-store/tasks.md#task-26
		 */
		...
		/**
		 * @spec openspec/changes/reverse-2026-05-26-fe-store/tasks.md#task-16
		 */
		...
		/**
		 * @spec openspec/changes/reverse-2026-05-26-fe-store/tasks.md#task-24
		 */
		...
		/**
		 * @spec openspec/changes/reverse-2026-05-26-fe-store/tasks.md#task-18
		 */
		...
		/**
		 * @spec openspec/changes/reverse-2026-05-26-fe-store/tasks.md#task-23
		 */
		...
		/**
		 * @spec openspec/changes/reverse-2026-05-26-fe-store/tasks.md#task-10
		 */
		...
		/**
		 * @spec openspec/changes/reverse-2026-05-26-fe-store/tasks.md#task-6
		 */
		...
		/**
		 * @spec openspec/changes/reverse-2026-05-26-fe-store/tasks.md#task-12
		 */
