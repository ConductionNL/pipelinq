		...
		<div class="form-row">
			<div class="form-group">
				<NcTextField
					...
					type="number"
					:modelValue="String(form.durationMinutes ?? '')"
			...
			<div class="form-group">
				<NcTextField
					...
					type="number"
					:modelValue="String(form.bufferBeforeMinutes ?? 0)"
					@update:modelValue="
			...
			<div class="form-group">
				<NcTextField
					...
					type="number"
					:modelValue="String(form.bufferAfterMinutes ?? 0)"
					@update:modelValue="
		...
		<div class="form-row">
			<div class="form-group">
				<NcTextField
					...
					type="number"
					:modelValue="String(form.price ?? 0)"
					@update:modelValue="
		...
		<div class="form-row">
			<div class="form-group">
				<NcTextField
					...
					type="number"
					:modelValue="String(form.depositAmount ?? 0)"
			...
			<div class="form-group">
				<NcTextField
					...
					type="number"
					:modelValue="String(form.noShowFee ?? 0)"
					@update:modelValue="
		...
		<div class="form-row">
			...
			<div class="form-group">
				<NcTextField
					...
					type="number"
					:modelValue="String(form.cancellationHoursBefore ?? 24)"
					@update:modelValue="
						(v) =>
