...
class RenameDutchColumns implements IRepairStep {
	...
	private const COLUMN_MAP = [
		...
		'aangevraagd_namens' => 'requested_namens',
		'aantal' => 'count',
		'actie' => 'action',
		'actor_rol' => 'actor_role',
		'adellijke_titel' => 'nobiliary_titel',
		'balans_na' => 'balans_after',
		'bedrag' => 'amount',
		'beloning_waarde' => 'beloning_value',
		...
		'gebruikt_op' => 'gebruikt_on',
		'geheimhouding' => 'secrecy',
		'geinitieerd_door' => 'geinitieerd_by',
		'gekoppeld_verzoek' => 'gekoppeld_request',
		'geldig_tot' => 'valid_to',
		'geldig_van' => 'valid_from',
		'gemeente_code' => 'municipality_code',
		'geslachtsnaam' => 'surname',
		'grondslag' => 'basis',
		'indicatie_geheim' => 'indication_geheim',
		'ingangsdatum' => 'effective_date',
		'initiated_op' => 'initiated_on',
		'is_formeel_geldig' => 'is_formeel_valid',
		'kanaal' => 'channel',
		...
		'kosten_in_punten' => 'cost_in_punten',
		'laatst_ontvangen_op' => 'latest_ontvangen_on',
		'laatste_synchronisatie' => 'last_synchronisation',
		'lokaal_opgevoerd_door' => 'local_opgevoerd_by',
		...
		'per_klant_limiet' => 'per_customer_limiet',
		'pipelinq_entiteit' => 'pipelinq_entity',
		'prioriteit' => 'priority',
		'referentienummer_rule' => 'reference_number_rule',
		'regel_id' => 'rule_id',
		'response_bevat_geheimhouding' => 'response_bevat_secrecy',
		...
		'tijdstip' => 'moment',
		'token_levensduur_seconden' => 'token_lifespan_seconden',
		'uitgegeven_aan' => 'uitgegeven_in',
		'uitgegeven_op' => 'uitgegeven_on',
		'validatie_tijdstip' => 'validation_moment',
		'verblijfplaats' => 'residence',
		'vervalt_op' => 'vervalt_on',
