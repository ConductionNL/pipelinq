...
/**
 * Pipelinq RenameDutchColumns Repair Step
 *
...
class RenameDutchColumns implements IRepairStep {
	 ...
	 *
	 * Pipelinq owns THREE registers — `pipelinq`, `pipelinq-portal` and `sla` —
	 * and the renamed properties are spread across all of them. A single
	 * `pipelinq%` match covers the first two and silently skips `sla`, whose
	 * 55-sla-engine.json carries five of them: their columns would keep the
	 * Dutch name for ever while every read looked at the English one.
	 *
	 * @var array<int, string>
	 */
	private const REGISTER_SLUG_PREFIXES = ['pipelinq', 'sla'];
	...
	private const COLUMN_MAP = [
		'aangemaakt' => 'created',
		'aangemaakt_op' => 'created_on',
		'aangevraagd_door' => 'requested_by',
		'aangevraagd_namens' => 'requested_on_behalf_of',
		'aantal' => 'count',
		'actie' => 'action',
		'actor_rol' => 'actor_role',
		'adellijke_titel' => 'nobiliary_title',
		'balans_na' => 'balance_after',
		'bedrag' => 'amount',
		'beloning_waarde' => 'remuneration_value',
		'beschrijving' => 'description',
		'betrokkenen_create_endpoint' => 'involved_parties_create_endpoint',
		'betrokkenen_list_endpoint' => 'involved_parties_list_endpoint',
		'bewaartot' => 'retain_until',
		'bron' => 'source',
		'brp_persoon_id' => 'brp_person_id',
		'btw_class' => 'vat_class',
		'cache_verloopt_op' => 'cache_expires_on',
		'conditie' => 'condition',
		'drempel_type' => 'threshold_type',
		'drempel_waarde' => 'threshold_value',
		'einddatum' => 'end_date',
		'geboortedatum' => 'date_of_birth',
		'geboorteland' => 'birth_country',
		'geboorteplaats' => 'birth_place',
		'gebruikt_op' => 'used_on',
		'geheimhouding' => 'secrecy',
		'geinitieerd_door' => 'initiated_by',
		'gekoppeld_verzoek' => 'linked_request',
		'geldig_tot' => 'valid_to',
		'geldig_van' => 'valid_from',
		'gemeente_code' => 'municipality_code',
		'geslachtsnaam' => 'surname',
		'grondslag' => 'basis',
		'indicatie_geheim' => 'indication_secret',
		'ingangsdatum' => 'effective_date',
		'initiated_op' => 'initiated_on',
		'is_formeel_geldig' => 'is_formal_valid',
		'kanaal' => 'channel',
		'klant_id' => 'customer_id',
		'klantcontacten_create_endpoint' => 'customer_contacts_create_endpoint',
		'klantcontacten_list_endpoint' => 'customer_contacts_list_endpoint',
		'klantcontacten_patch_endpoint' => 'customer_contacts_patch_endpoint',
		'klantcontacten_update_endpoint' => 'customer_contacts_update_endpoint',
		'kosten_in_punten' => 'cost_in_points',
		'laatst_ontvangen_op' => 'latest_received_on',
		'laatste_synchronisatie' => 'last_synchronisation',
		'lokaal_opgevoerd_door' => 'local_entered_by',
		'lookup_verzoek_id' => 'lookup_request_id',
		'maak_klantcontact_composite_rule' => 'create_customer_contact_composite_rule',
		'maak_klantcontact_endpoint' => 'create_customer_contact_endpoint',
		'max_per_klant_per_periode' => 'max_per_customer_per_period',
		'max_per_klant_periode' => 'max_per_customer_period',
		'merk' => 'brand',
		'met_at' => 'with_at',
		'naam' => 'name',
		'notitie' => 'note',
		'opgehaald_op' => 'fetched_on',
		'partijen_create_endpoint' => 'parties_create_endpoint',
		'partijen_list_endpoint' => 'parties_list_endpoint',
		'per_klant_limiet' => 'per_customer_limit',
		'pipelinq_entiteit' => 'pipelinq_entity',
		'prioriteit' => 'priority',
		'referentienummer_rule' => 'reference_number_rule',
		'regel_id' => 'rule_id',
		'response_bevat_geheimhouding' => 'response_contains_secrecy',
		'response_duur_ms' => 'response_duration_ms',
		'response_tijdstip' => 'response_moment',
		'retentie_tot' => 'retention_to',
		'startdatum' => 'start_date',
		'taal' => 'language',
		'tier_behaald_op' => 'tier_achieved_on',
		'tier_geldig_tot' => 'tier_valid_to',
		'tijdstip' => 'moment',
		'token_levensduur_seconden' => 'token_lifespan_seconds',
		'uitgegeven_aan' => 'issued_in',
		'uitgegeven_op' => 'issued_on',
		'validatie_tijdstip' => 'validation_moment',
		'valuta' => 'currency',
		'verblijfplaats' => 'residence',
		'vervalt_op' => 'expires_on',
		'verwerkt_door' => 'processed_by',
		'verzoek_id' => 'request_id',
		'verzoek_tijdstip' => 'request_moment',
		...
		'zaak_id' => 'case_id',
		'zaaktype' => 'case_type',
		'beloning_code' => 'reward_code',
		'beloning_type' => 'reward_type',
		'beperkt' => 'limited',
		'brondocument' => 'source_document',
		'bronsysteem' => 'source_system',
		'contactmoment_id' => 'interaction_id',
		'created_contactmoment_id' => 'created_interaction_id',
		'current_balans' => 'current_balance',
		'doelbinding' => 'purpose_binding',
		'downgrade_beleid' => 'downgrade_policy',
		'elfproef_score' => 'eleven_test_score',
		'formule' => 'formula',
		'geslacht' => 'gender',
		'ingevoerd_bsn' => 'entered_bsn',
		'initiale_balans' => 'initial_balance',
		'ip_adres' => 'ip_address',
		'kost_basis_eur' => 'cost_basis_eur',
		'secret_kluis_ref' => 'secret_vault_ref',
		'uitkomst' => 'outcome',
		'upgrade_beleid' => 'upgrade_policy',
	];
	...
	public function getName(): string {
		return 'Move pipelinq data from the Dutch columns to the English ones';
	}//end getName()

	/**
	 * Run the column migration across every pipelinq shard table.
	 *
	...
	public function run(IOutput $output): void {
		...
		if ($tables === []) {
			$output->info('RenameDutchColumns: no pipelinq shard tables on this install; nothing to do.');
			return;
		}
